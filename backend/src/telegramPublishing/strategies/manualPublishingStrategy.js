...
class ManualPublishingStrategy extends PublishingStrategyInterface {
  constructor() {
    super('manual');
  }
  ...
  async execute(publishingTask, context = {}) {
    ...
    logger.info(`[ManualPublishingStrategy] Executing manual publish for task '${publishingTask.taskId}'`);
    return client.sendMessage(targetChannel.channelId, renderedMessage, { parse_mode: 'Markdown' });
  }
}

module.exports = ManualPublishingStrategy;
